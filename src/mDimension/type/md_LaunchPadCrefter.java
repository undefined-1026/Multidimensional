 ...
 * 但是液体消耗还是每帧的量，*/
public class md_LaunchPadCrefter extends GenericCrafter {
    ...
    public md_LaunchPadCrefter(String name) {
        super(name);
    ...
    public class md_LaunchPadCrefterBuild extends GenericCrafterBuild{
